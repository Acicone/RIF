function options = Settings_FRIF_v1(varargin)
% 
% Settings_FRIF_v1 Constructs option structure for the algorithms
%
% EXAMPLES
%
% OPTIONS = Settings_FRIF_v1 with no input arguments returns
%   setting structure with default values
%
% OPTIONS = Settings_FRIF_v1('NAME1',VALUE1,'NAME2',VALUE2,...) creates a
%   solution options structure OPTIONS in which the named properties have
%   the specified values.  Any unspecified properties have default values.
%   It is sufficient to type only the leading characters that uniquely
%   identify the property.  Case is ignored for property names.
%
% OPTIONS = Settings_FRIF_v1(OLDOPTIONS,'NAME1',VALUE1,...) alters an existing options
%   structure OLDOPTIONS.
%
%
% Settings_FRIF_v1 PROPERTIES :
%
% GENERAL
% 
...
%  UpSampling  (8)     Number of sample points in each period                         
...
% EXAMPLE
%          
%   >> options = Settings_FRIF_v1('delta',0.08,'NIMFs',5,'plots',1) 
%   >> IMF = FRIF_v1_1(x,options)
%              
%  Executes algorithm FRIF_v1_1 with delta = 0.08, stops after we have at most 5 IMFs and a trend, it produces plots.                            
% ------------------------------------------------------      
%
% See also FRIF_v1_1
%
